...
if page == "Overview":
    ...
    st.table(quick.head(10).style.set_table_styles([{'selector':'th','props':[('color','white'),('background-color','#0b1220')]},{'selector':'td','props':[('color','white'),('background-color','#071225')]}))
